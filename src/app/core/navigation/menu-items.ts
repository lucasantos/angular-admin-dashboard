...
export const menuItems: MenuItems[] = [
  ...
  },
  {
    ...
    component: () => import('../../features/support/ui/help-menu/faq/faq').then((m) => m.Faq),
  },
  {
    label: 'menu.support',
    icon: 'support',
    route: '/support',
    hidden: true, // This route won't appear in the main menu but can be accessed via the Help menu
    component: () => import('../../features/support/ui/help-menu/support/support').then((m) => m.Support),
  },
  {
    label: 'menu.profile',
    icon: 'person',
    ...
    component: () => import('../../features/user/ui/account-menu/profile/profile').then((m) => m.Profile),
  },
  {
    ...
    hidden: true, // This route won't appear in the main menu but can be accessed via the Account menu
    component: () => import('../../features/user/ui/account-menu/settings/settings').then((m) => m.Settings),
  },
  {
    ...
    hidden: true, // This route won't appear in the main menu but can be accessed via the Account menu
    component: () =>
      import('../../features/user/ui/account-menu/security-privacy/security-privacy').then(
        (m) => m.SecurityPrivacy,
      ),
  },
  {
